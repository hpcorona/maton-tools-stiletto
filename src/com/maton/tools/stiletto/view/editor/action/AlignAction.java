...
public class AlignAction extends Action {
	...
	static String DESCRIPTIONS[] = { "Align bottom", "Align center",
			"Align left", "Align middle", "Align right", "Align top" };

	static ImageDescriptor IMAGES[] = {
			ImageDescriptor.createFromFile(AlignAction.class,
	...
	public void run() {
		Positioned positioned = table.getSelected();
		if (positioned == null) {
			return;
		}
